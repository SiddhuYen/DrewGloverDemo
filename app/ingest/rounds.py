...
def ingest_rounds_for_firm(db: Session, firm_name: str, *,
    ...
    for round_ in funding.rounds_for_firm(firm_name):
        ...
        orgs = [anchor]
        for other in others:
            if new_firms >= config.MAX_COINVESTOR_FIRMS:
                break
        ...
        # The org-level fact is recorded regardless; person edges need a roster.
        ...
        if unreadable:
            # Never let "we could not read their team page" look like
